...
object *readstring (char delim, gfun_t gfun);  //forward definition
void superprint (object *form, int lm, pfun_t pfun);  //forward definition
int subwidth (object *obj, int w);  //forward definition
boolean atom (object *x);  //forward definition
void pfstring (const char *s, pfun_t pfun);  //forward definition
boolean valid40 (char *buffer);  //forward definition
...
#define NRF52832
  ...
  #define WORKSPACESIZE 16000      //4032=4096-32              /* Cells (8*bytes) */
  #define SYMBOLTABLESIZE 512             /* Bytes */
  uint8_t _end;
#endif
